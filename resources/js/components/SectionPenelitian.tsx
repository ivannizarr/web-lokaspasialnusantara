...
const SectionPenelitian = () => {
  return (
    <section
      id="penelitian"
      className="flex flex-col w-full bg-cover bg-center text-white"
      style={{ backgroundImage: "url('/img/penelitian.jpg')" }}
    >
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-10 lg:px-20 flex flex-col items-center justify-center min-h-screen gap-8 text-center">
        <div className="mx-2 w-full max-w-5xl rounded-2xl bg-gray-950/50 px-6 py-6 text-white">
          ...
          <p className="font-nunito mb-4 text-sm sm:text-base md:text-lg leading-relaxed drop-shadow-[0_2px_20px_rgba(0,0,0,0.8)]">
            Kami mendukung kegiatan riset melalui pengumpulan, pengolahan, dan analisis data berbasis teknologi, baik di bidang lingkungan, sosial, maupun teknis. Setiap proyek penelitian dikembangkan dengan pendekatan ilmiah dan metodologi yang relevan dengan kebutuhan mitra dan masyarakat.
          </p>
...
export default SectionPenelitian;
