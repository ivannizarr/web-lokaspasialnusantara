  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-10 lg:px-20 flex flex-col items-center justify-center min-h-screen gap-8 text-center">
        <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-6xl text-yellow-400 font-extrabold font-nunito drop-shadow-[0_4px_80px_rgba(0,0,0,0.9)]">
          Siapa Kami
        </h2>
        ...
        <button
          ...
          className="cursor-pointer mx-auto flex items-center gap-3 px-5 py-2 text-xs font-bold text-white border border-white rounded-md hover:bg-sky-800 transition-all duration-100"
        >
