...
const SectionWebApp = () => {
  return (
    <section
      ...
      style={{ backgroundImage: "url('/img/web-app.jpg')" }}
    >
      ...
      <div className="relative z-10 px-4 sm:px-6 md:px-10 lg:px-20 flex flex-col items-center justify-center min-h-screen gap-8 text-center">
        <div className="mx-2 w-full max-w-5xl rounded-2xl bg-gray-950/50 px-6 py-6 text-white">
          ...
          <p className="font-nunito mb-4 text-sm sm:text-base md:text-lg leading-relaxed drop-shadow-[0_2px_20px_rgba(0,0,0,0.8)]">
            Kami menyediakan layanan pengembangan sistem digital yang mencakup website informatif, aplikasi fungsional, dan dashboard interaktif. Setiap produk dirancang sesuai kebutuhan pengguna dengan memperhatikan aspek UX/UI, kecepatan akses, dan integrasi dengan sistem yang sudah ada.
          </p>
