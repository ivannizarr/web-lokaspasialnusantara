...
const Slide = ({ slide }: SlideProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-2 max-w-3xl rounded-2xl bg-gray-950/65 px-4 py-3 text-center text-white">
        ...
        <button className="font-nunito font-semibold cursor-pointer rounded-lg border border-white px-4 py-1 text-sm text-white transition hover:bg-[#02517A] md:px-6 md:py-2 md:text-sm">
          {t(`${slide.key}.button`)}
        </button>
      </div>
    </motion.div>
